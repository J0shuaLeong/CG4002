...
class NodeRelayServer:
    ...
    def handle_client(self, client_socket, AI_data_queue, visualiser_queue_1, visualiser_queue_2):
        ...
        try:
            while True:
                ...
                # uncomment for soccer 
                    ...
                    json_message = json.dumps({
                    "player_id": player_id,      # player 1
                    "is_shot": message_data.get("is_shot"),
                    "type": "action",
                    "action": "is_shot"
                    })
                    print(f"is_shot: {json_message}")
                    # TODO put into game visualiser player 1 queue
                    if player_id == "1":
                        visualiser_queue_2.put(json_message)
                    elif player_id == "2":
                        visualiser_queue_1.put(json_message)
    ...
    def start(self, AI_data_queue, server_data_queue, visualiser_queue_1, visualiser_queue_2):
        self.setup_server()
        ...
        try:
            while True:
                ...
                threading.Thread(target=self.handle_client, args=(client_socket, AI_data_queue, visualiser_queue_1, visualiser_queue_2), daemon=True).start()
