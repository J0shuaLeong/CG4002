            ...
            if packet_count <= 60:
                ...
                if device_id == 1 and not device_1_inferred and not p1_response_flag:
                    ...
                    if action != "null":
                        ...
                        print(f"{ConsoleColors.AIOUTPUT}p1 redo glove action{ConsoleColors.RESET}")

                    device_1_inferred = True  # Mark inference as done

                elif device_id == 4 and not device_4_inferred and not p1_response_flag:
                    ...
                    if action != "null":
                        ...
                        print(f"{ConsoleColors.AIOUTPUT}p1 redo leg action{ConsoleColors.RESET}")
                    ...
                    if action != "null":
                        ...
                        print(f"{ConsoleColors.AIOUTPUT}p2 redo glove action{ConsoleColors.RESET}")

                    device_5_inferred = True  # Mark inference as done

                elif device_id == 8 and not device_8_inferred and not p2_response_flag:
                    ...
                    if action != "null":
                        ...
                        print(f"{ConsoleColors.AIOUTPUT}p2 redo leg action{ConsoleColors.RESET}")
...
def eval_server_thread(eval_client, players, unity_stats_queue, hardware_data_queue, visualiser_queue_1, visualiser_queue_2, p1_response_flag, p2_response_flag):
    ...
    def send_random_action(player_id):
        ...
        random_action = random.choice(["gun", "soccer", "reload", "shield", "bowl", "basket"])  # Define random actions as needed
    ...
    def start_timer_for_other_player(player_id):
        ...
        timer = threading.Timer(40.0, reset_flags)
        print(f"Starting 40-second timer for Player {player_id}")
        timer.start()
