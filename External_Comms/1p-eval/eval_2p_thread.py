        ...
        try:
            ...
            if packet_count <= 60:
                ...
                if device_id == 1 and not device_1_inferred:
                    ...
                    print(f"{ConsoleColors.PURPLE}AI_action put into visualiser_queue_{player_id}{ConsoleColors.RESET}")
...
def handle_visualiser_message(message_data, mqtt_client, vis_number):
    ...
    if message_type == "eval_ground_truth":
        ...
        print("Unkown message type, visualiser unable to process")
...
def handle_eval_ground_truth(message_data, mqtt_client, vis_number):
    ...
    print(f"eval_ground_truth sent to visualiser {vis_number}")
...
def handle_action_message(message_data, mqtt_client):
    ...
    print(f"P{player_id} - Published action to MQTT topic '{topic}': {action}")
    ...
    while True:
        try:
            ...
            if player_id == 1:
                ...
                visualiser_queue_2.put(json.dumps(action_message_input))        # string
